    ...
    <div style={{ width: '100%' }}>
      ...
      {loading ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
          ...
          {/* FUNGSI HELPER UNTUK RENDER GRID */}
          {[
                ...
                <div className="user-grid">
                  {filteredUsers.map((user) => (
                    ...
                    >
                      ...
                      {/* --- INDIKATOR WARNA KARTU (Opsional agar makin jelas) --- */}
                      <div style={{
          ...
          <div className="modal-box custom-scroll" style={{ maxWidth: '500px' }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body custom-scroll" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', fontSize: '13px' }}>
                ...
                {/* --- TAMBAHAN: STATUS SISWA DENGAN BADGE WARNA --- */}
                <div style={{ gridColumn: 'span 2' }}>
                  ...
                  <div style={{
                    ...
                    // Logika Pewarnaan Berdasarkan Status (Default ke Aktif jika belum ada data)
              ...
              <div className="modal-body custom-scroll" style={{ maxHeight: '60vh', overflowY: 'auto', paddingRight: '10px' }}>
                ...
                <div style={{ marginBottom: '10px' }}>
                  ...
                  <select
                    ...
                    style={{
                      fontWeight: '600',
                      color: formData.status === 'Aktif' ? '#16a34a' : formData.status === 'Lulus' ? '#2563eb' : '#dc2626',
                      border: `1px solid ${formData.status === 'Aktif' ? '#bbf7d0' : formData.status === 'Lulus' ? '#bfdbfe' : '#fecaca'}`,
                      backgroundColor: formData.status === 'Aktif' ? '#f0fdf4' : formData.status === 'Lulus' ? '#eff6ff' : '#fef2f2'
                    }}
                  >
